...
export default function PerformancePage() {
   ...
   * DEPARTMENTS
   *
   * Departments are taken from real employees.
   ...
   * IMPORTANT:
   *
   * The backend endpoint returns ONLY employees who do not
   * already have a review for the selected month.
   *
   * "All" sends no department filter.
   * ============================================================
  ...
  /*
   * ============================================================
   * REFRESH AVAILABLE EMPLOYEES WHEN:
   *
   * - Modal opens
   * - Review month changes
   * - Department changes
   *
   * Do NOT run this in edit mode.
   * ============================================================
            ...
            <div className="overflow-y-auto px-6 py-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  {editingReview ? (
                    <p className="mt-1.5 text-xs text-gray-500">
                      Department is locked while editing.
                    </p>
                  ) : (
                    <p className="mt-1.5 text-xs text-gray-500">
                      Choose All Departments to see every employee who has not been reviewed for the selected month.
                    </p>
                  )}
                </div>
